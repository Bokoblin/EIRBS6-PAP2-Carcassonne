...
static struct card_type ct_CARD_MONASTERY_ROAD = {CARD_MONASTERY_ROAD,
        {FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, ROAD, FIELD, FIELD, FIELD, FIELD, ABBEY}};
...
static struct card_type ct_CARD_ROAD_STRAIGHT_CITY = {CARD_ROAD_STRAIGHT_CITY,
        {FIELD, ROAD, FIELD, FIELD, FIELD, FIELD, FIELD, ROAD, FIELD, CITY, CITY, CITY, ROAD}};

static struct card_type ct_CARD_CITY_ONE_SIDE = {CARD_CITY_ONE_SIDE,
        {CITY, CITY, CITY, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD, FIELD}};
...
static struct card_type ct_CARD_PLAIN_TUNNEL = {CARD_PLAIN_TUNNEL,
        {FIELD, FIELD, FIELD, CITY, CITY, CITY, FIELD, FIELD, FIELD, CITY, CITY, CITY, FIELD}};
...
static struct card_type ct_CARD_ROAD_TURN_RIGHT_CITY = {CARD_ROAD_TURN_RIGHT_CITY,
        {CITY, CITY, CITY, FIELD, FIELD, FIELD, FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, FIELD}};
...
static struct card_type ct_CARD_JUNCTION_CITY = {CARD_JUNCTION_CITY,
        {FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, CITY, CITY, CITY, INTERSECTION}};
...
static struct card_type ct_CARD_PLAIN_CITY_ROAD_SHLD = {CARD_PLAIN_CITY_ROAD_SHLD,
        {CITY, CITY, CITY, CITY, CITY, CITY, FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, FIELD}};
...
static struct card_type ct_CARD_CITY_THREE_SHLD = {CARD_CITY_THREE_SHLD,
        {CITY, CITY, CITY, CITY, CITY, CITY, FIELD, FIELD, FIELD, CITY, CITY, CITY, CITY}};
...
static struct card_type ct_CARD_CITY_THREE_ROAD_SHLD = {CARD_CITY_THREE_ROAD_SHLD,
        {CITY, CITY, CITY, CITY, CITY, CITY, FIELD, ROAD, FIELD, CITY, CITY, CITY, CITY}};
...
static struct card_type ct_CARD_ROAD_STRAIGHT = {CARD_ROAD_STRAIGHT,
        {FIELD, ROAD, FIELD, FIELD, FIELD, FIELD, FIELD, ROAD, FIELD, FIELD, FIELD, FIELD, ROAD}};
...
static struct card_type ct_CARD_JUNCTION_THREE = {CARD_JUNCTION_THREE,
        {FIELD, FIELD, FIELD, FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, FIELD, ROAD, FIELD, INTERSECTION}};
