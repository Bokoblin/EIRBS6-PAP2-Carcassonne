...
{
    //CLIENT 4410 - ALWAYS CHOOSE THE MOVE WITH THE MOST UPPER RIGHT CARD
    ...
    struct move chosen_move = *((struct move *) set__get_umpteenth_no_copy(possible_moves, moves_number - 1));
...
{
    return("4410 - \"Always upper right\"");
}
